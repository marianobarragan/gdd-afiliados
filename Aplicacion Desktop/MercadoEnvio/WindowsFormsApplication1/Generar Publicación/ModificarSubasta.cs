    ...
    public partial class ModificarSubasta : Form
    {
        ...
        private void ModificarSubasta_Load(object sender, EventArgs e)
        {
            ...
            if (estadoInicial == "ACTIVA")
            {
                ...
                txtValorInicialDecimal.Enabled = false;
        ...
        private void cmdGenerarCompra_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string comando = "UPDATE DBME.publicacion SET descripcion = '" + descripcion + "',stock = " + stock + ",fecha_creacion = '" + fechaInicio + "',fecha_vencimiento ='" + fechaVencimiento + "',valor_inicial=" + precio + "." + txtValorInicialDecimal.Text + ",rubro_id=" + rubro + ",visibilidad_id=" + visibilidad_id + ",estado = '" + estado + "', permite_preguntas = '" + permitePreguntas + "', realiza_envio ='" + realiza_envio + "', costo =" + costo_total + "WHERE publicacion_id= " + id_publicacion;
